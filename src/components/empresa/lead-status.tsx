...
export const LEAD_STATUSES: { value: LeadStatus; label: string; className: string }[] = [
  ...
  { value: "CONTACTADO", label: "Contactado", className: "border-blue-500/25 text-info" },
  { value: "COTIZANDO", label: "Cotizando", className: "border-sand/30 text-sand-fg" },
  { value: "NEGOCIACION", label: "Negociación", className: "border-amber-500/30 text-warn" },
  { value: "GANADO", label: "Ganado", className: "border-green-500/30 text-ok" },
  { value: "PERDIDO", label: "Perdido", className: "border-red-500/25 text-danger" },
];
