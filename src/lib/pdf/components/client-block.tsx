...
const s = StyleSheet.create({
  ...
  block: { flex: 1, backgroundColor: COLORS.bgCard, borderRadius: 4, padding: SPACING.md },
  ...
  dateBlock: { flex: 1, backgroundColor: COLORS.bgCard, borderRadius: 4, padding: SPACING.md },
