...
export const COMPLEXITY: Record<string, ComplexityTier> = {
  academyx: 5, "uapa-suite": 5, visita7: 4, "smart-church": 3, sembradores: 4, "pime-backup": 5, "holo-realty": 3, "wedding-site": 3, godmode: 4, cifrapp: 4, misaza: 4, "bnb-real-estate": 3, "john-henry": 3,
};
