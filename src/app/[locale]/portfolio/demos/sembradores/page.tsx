...
import { SembradoresMemberDashboard } from "@/components/demos/sembradores-member-dashboard";

const TECH = ["Next.js 15", "Turborepo", "Supabase", "pnpm", "Brevo", "Yappy", "Banco General", "PWA", "ExcelJS", "Recharts"];

export default function SembradoresDemoPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    <div className="min-h-screen bg-[#030611] text-white">
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
        <nav className="mb-6 flex items-center gap-2 text-[10px] uppercase tracking-[0.3em] text-white/30">
          ...
          <span>/</span>
          <span className="text-[#60A5FA]">Sembradores Demo</span>
        </nav>
        ...
        >
          ...
          <h1 className="text-3xl font-bold leading-tight sm:text-4xl">
            Sembradores — Church Management SaaS
          </h1>
          <p className="max-w-2xl text-base text-white/55">
            White-label church management platform: 12 complete feature phases, 68 SQL migrations,
            double-entry accounting, payment gateways, and a PWA member portal.
          </p>
