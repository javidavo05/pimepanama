        ...
        <div className="space-y-2">
          {meetings.map((m) => (
            <Link
              ...
              className="block border border-line hover:border-line-mid rounded-xl p-3 transition-all group"
            >
              ...
              {m.contextSummary && (
                <p className="text-fg-dim text-xs mt-1.5 leading-relaxed line-clamp-3">
                  {m.contextSummary}
                </p>
              )}
            </Link>
