-- Migration 0013: Historial de auditoría de documentos
-- Registra quién editó un documento (ej. una factura ya pagada) y cuándo, con un
-- resumen legible de los campos que cambiaron.
